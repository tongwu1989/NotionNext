...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '财经掌门小木', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享市场的好策略', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hcelue.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，好策略', // 网站关键词 英文逗号隔开
